...
//		end
	...
	//	//storing the number 25 in the memory, in position 31
	//	arch.tGetMemory().getDataList()[31]=25;
	...
	//	arch.tGetMemory().getDataList()[12]=31;
	...
	//	assertEquals(155, arch.tGetMemory().getDataList()[31]);
	...
	//	arch.tGetMemory().getDataList()[31]=1;
	//	//storing the number 0 in the memory, in position 32
	//	arch.tGetMemory().getDataList()[32]=0;
	...
	//	assertEquals(5, arch.tGetMemory().getDataList()[0]);
	//	assertEquals(4, arch.tGetMemory().getDataList()[1]);
	//	assertEquals(3, arch.tGetMemory().getDataList()[2]);
	//	assertEquals(2, arch.tGetMemory().getDataList()[3]);
	//	assertEquals(1, arch.tGetMemory().getDataList()[4]);
	//	assertEquals(0, arch.tGetMemory().getDataList()[5]);
	//}
